    ...
    <div className={styles.navigation}>
      <div className={styles.name}>
        <svg viewBox="0 0 431 221" xmlns="http://www.w3.org/2000/svg">
          <g>
            <path
              d="M0 221V0H395L340.571 131.04L0 221Z"
              fill="#FF7B39"
              fillOpacity="0.61"
            />
      ...
      <div className={styles.navigators}>
        ...
        >
          <g>
            <path
              d="M42 0H642V108.898L196.889 126L42 0Z"
              fill="#FF7B39"
              fillOpacity="0.57"
            />
      ...
      <div className={styles.title}>
        <svg viewBox="0 0 763 221" xmlns="http://www.w3.org/2000/svg">
          <g>
            <path
              d="M0 198L11.5157 0L709.969 29.7L733 140.766L0 198Z"
              fill="#FF7B39"
              fillOpacity="0.63"
            />
            <path
              d="M15 221L26.7514 23L739.497 52.7L763 163.766L15 221Z"
              fill="#FF7B39"
            />
          </g>
          <text x="38" y="140">
